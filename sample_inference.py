...
tasks = {
    "text": {
        "compiled_id": "jgnezz1qg",
        "dataset_id": "d9pgmkwy9"
    },
    "image": {
        "compiled_id": "jgovllmx5",
        "dataset_id": "d2rexdrp7"
    }
}
...
result = evaluate_track1(
    ...
    "dataset/lpcvc_sample_data/txt_list.csv",
    "dataset/lpcvc_sample_data/img_list.csv"
)
print(result)