...
image_folder = "dataset/lpcvc_sample_data/images"  # change to your folder
...
# TODO: Load txt CSV
csv_path = "dataset/lpcvc_sample_data/txt_list.csv"
...
print(qai_hub.upload_dataset({"input_ids": tokenized_texts}))